...
const Login= () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className="h-[80vh] flex items-center">
            <div className="flex flex-col gap-3 m-auto items-start p-8 w-[340px] sm:w-96 border rounded-xl text-[#5E5E5E] text-sm shadow-lg ">
